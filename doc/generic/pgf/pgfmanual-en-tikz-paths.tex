...
To add a tiny bit of safety when using it on a path anyway and the contents of
|\pgfextra| contain drawing commands, those should be enclosed between
|\pgfinterruptpath| and |\endpgfinterruptpath|.
