...
%
\begin{itemize}
    \item |luatex| version 1.12.0 or higher.
    \item |pdftex| version 1.40.21 or higher.
    \item |dvips| version 2020.1 or higher.

        For inter-picture connections, you need to process pictures using
        |pdftex| version 1.40.21 or higher running in DVI mode.
    \item |dvipdfm| version 20200315 or higher.

        For inter-picture connections, you need to process pictures using
        |pdftex| version 1.40.21 or higher running in DVI mode.
    \item |dvipdfmx| version 20200315 or higher.
    \item |dvisvgm| version 2.9.1 or higher.
    \item |tex4ht| version 2018-07-03 or higher.
    \item |xetex| version 0.999992 or higher.
\end{itemize}
