...
\begin{tikzpicture}
  ...
  \fill (x.north)      circle [radius=2pt] node[above] {\texttt{north}}
        (x.north east) circle [radius=2pt] node[above] {\texttt{north east}}
        (x.north west) circle [radius=2pt] node[above] {\texttt{north west}}
        (x.west) circle [radius=2pt]       node[left]  {\texttt{west}}
        (x.east) circle [radius=2pt]       node[right] {\texttt{east}}
        (x.base) circle [radius=2pt]       node[below] {\texttt{base}};
\end{tikzpicture}
