...
\begin{key}{/tikz/z=\meta{value} (initially \normalfont$-3.85$mm)}
    ...
    The default $z$-axis vector $(-3.85\text{mm},-3.85\text{mm})$ behaves as a
    shear to make the $z$ part of coordinates visible when projected onto the
    flat page.

    A $z$-axis vector of $(0,0)$, e.g., |z=0pt| gives a $z$-axis pointing
    directly out of the page.  This is good if you're applying your own
    rotations to construct and then view a 3D object from some angle (view in
    the sense of project the rotated parts onto the page as the XY plane).
    %
\begin{codeexample}[]
